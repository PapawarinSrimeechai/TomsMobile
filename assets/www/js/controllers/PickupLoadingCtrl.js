app.controller('PickupLoadingCtrl', function($scope, $ionicHistory, $ionicPopup, $ionicModal, $state,SessionService,APIService,$localStorage,PageService,DeviceService,Languages,Deviceconfig,WLog,ShipmentAPI,Spots) {
    // Check Session login
    ...
    DeviceService.chk_device_status(function(net_status, gps_status, box_status) {
        ...
        if ($scope.device_status[0] == 1 && $scope.device_status[1] == 1 && $scope.device_status[2] == 1) {
            ...
            APIService.AppConfig.getchktom(function(TOMs_status) {
                    ...
                    console.log('######## TM11 TOMs_status :' + $scope.TOMs_status);
                })
    ...
    Languages.getDBlang($localStorage.lang_id, 'TM11', function(result) {
    ...
    Spots.updateDBspot("spot_status", $localStorage.ship_id, $localStorage.ship_spot_id, "ELS", function(updateDBspot_status){
        ...
        $('.pickup-loading, #pickup-loading-confirm__modal').velocity({
            ...
            complete: function() {
                ...
                $ionicHistory.nextViewOptions({
                 ...
                 // Page Config
                $scope.page = PageService.find_page('TM12');
